...
def main():
    ...
    with sm_top:
        ...
        smach.StateMachine.add('MOVE1', smach_ros.SimpleActionState('/move_base', MoveBaseAction, goal=goal1), transitions={'succeeded':'YOLO_START', 'preempted':'MOVE1', 'aborted':'MOVE1'})
        ...
        smach.StateMachine.add('MOVE3', smach_ros.SimpleActionState('/move_base', MoveBaseAction, goal=goal), transitions={'succeeded':'DETECT_AREA', 'preempted':'exit', 'aborted':'MOVE2'})
        ...
        smach.StateMachine.add('MOVE4', smach_ros.SimpleActionState('/move_base', MoveBaseAction, goal=goal3), transitions={'succeeded':'exit', 'preempted':'MOVE1', 'aborted':'MOVE2'})
